...
const cards = [
    ...
    {
        image: [ { width: 1000, height: 650, ctxid: "2KXJ8ZSVNXL1T" } ],
    ...
    {
        image: [ { width: 1000, height: 650, ctxid: "2KXJ8ZSU09S1F" } ],
    ...
    {
        image: [ { width: 1000, height: 650, ctxid: "2KXJ8ZSJ9Q7PB" } ],
...
export default component$(() => {
    function srcsetter(mei: string) {
        return `https://collections.newberry.org/IIIF3/Image/${mei}/full/400,/0/default.jpg 400w, https://collections.newberry.org/IIIF3/Image/${mei}/full/800,/0/default.jpg 800w, https://collections.newberry.org/IIIF3/Image/${mei}/full/1500,/0/default.jpg 1500w, https://collections.newberry.org/IIIF3/Image/${mei}/full/3000,/0/default.jpg 3000w,`;
    }
    return (
        <>
            <main
            ...
            >
                ...
                <div class="right">
                    <div class="gallery">
                        {cards.map((card, idx) => <Card data={card} /> )}
                    </div>
                </div>
            </main>
        </>
